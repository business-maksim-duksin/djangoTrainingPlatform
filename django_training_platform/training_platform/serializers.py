...
# class CourceSerializer(OwnerTrackingModelSerializer):
#     """test cource serializer"""
#
#     owner = serializers.PrimaryKeyRelatedField(read_only=True, default=serializers.CurrentUserDefault())
#     class Meta:
#         model = Course
...
#
#
# class LessonSerializer(OwnerTrackingModelSerializer):
#     """test lesson serializer"""
#
#     class Meta:
#         model = Lesson
#         fields = "__all__"
#
#
# class TaskSerializer(OwnerTrackingModelSerializer):
...
#
#
# class CourceSerializer2(serializers.ModelSerializer):
#     """test cource serializer"""
#
#     # owner = serializers.PrimaryKeyRelatedField(read_only=True, default=serializers.CurrentUserDefault())
#     class Meta:
...
#
#
# class CourceSerializer3(serializers.ModelSerializer):
#
#     class Meta:
#         model = Course
#         fields = "__all__"
